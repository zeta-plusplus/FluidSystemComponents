...
equation
  ...
  connect(Shock.portStatWithMn_2, FluidStatMn2port.portStatWithMn) annotation(
    Line(points = {{20, 19}, {36, 19}}, color = {0, 127, 255}, thickness = 3));
  ...
  connect(FluidStatMn2port.port, boundary1.ports[1]) annotation(
    Line(points = {{40, 27}, {56, 27}}, color = {0, 127, 255}, thickness = 3));
...
annotation(
    ...
    __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG