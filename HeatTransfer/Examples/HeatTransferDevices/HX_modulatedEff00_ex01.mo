...
model HX_modulatedEff00_ex01
  ...
  HeatTransfer.Components.HX_modulatedEff00 HX(redeclare package Medium1 = liquid1, redeclare package Medium2 = liquid2) annotation(
...
equation
  ...
  connect(ramp1.y, HX.u_eff) annotation(
    Line(points = {{-59, 0}, {-49, 0}, {-49, 10}, {-22, 10}}, color = {0, 0, 127}));
  annotation(
