...
model HX_Parallel_NTU00_ex01
  ...
  Components.HX_ParallelFlow_NTU00 HX(redeclare package Medium1 = liquid1, redeclare package Medium2 = liquid2, A_par = 10) annotation(
