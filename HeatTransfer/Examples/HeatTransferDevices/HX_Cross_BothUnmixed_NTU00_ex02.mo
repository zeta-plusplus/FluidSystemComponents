...
model HX_Cross_BothUnmixed_NTU00_ex02
  ...
  FluidSystemComponents.HeatTransfer.Components.HX_CrossFlow_BothUnmixed_NTU00 HX(redeclare package Medium1 = liquid1, redeclare package Medium2 = liquid2, A_par = 10, swDetermine_eff = Types.Switches.switchHowToDetVar.param, swDetermine_A = Types.Switches.switchHowToDetVar.asCalculated) annotation(
...
equation
  ...
  connect(boundary1.ports[1], HX.port_1_med2) annotation(
    Line(points = {{-60, -40}, {-42, -40}, {-42, -7}}, color = {0, 127, 255}));
  connect(HX.port_2_med2, pipe1.port_a) annotation(
    Line(points = {{4, -7}, {4, -30}, {20, -30}}, color = {0, 127, 255}));
  annotation(
...
end HX_Cross_BothUnmixed_NTU00_ex02;
