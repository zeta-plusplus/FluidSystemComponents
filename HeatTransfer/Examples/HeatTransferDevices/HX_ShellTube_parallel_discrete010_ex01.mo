...
model HX_ShellTube_parallel_discrete010_ex01
  ...
  FluidSystemComponents.Sensor.SpecificHeatCapacity Cp_coldIn(redeclare package Medium = liquidCside) annotation(
    Placement(visible = true, transformation(origin = {-175, -63}, extent = {{-5, -5}, {5, 5}}, rotation = 270)));
  ...
  Modelica.Blocks.Math.Product Capacity_hotIn annotation(
    Placement(visible = true, transformation(origin = {-187, -85}, extent = {{-5, -5}, {5, 5}}, rotation = -90)));
  ...
  Modelica.Blocks.Sources.Ramp ramp_T_coldIn(duration = 1, height = 0, offset = 10 + 273.15, startTime = 25) annotation(
    Placement(visible = true, transformation(origin = {-255, -56}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Ramp ramp_m_flow_cold(duration = 1, height = 0, offset = 2, startTime = 20) annotation(
    Placement(visible = true, transformation(origin = {-255, -40}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
...
equation
  ...
  connect(m_flow_cold.port_b, volC.ports[2]) annotation(
    Line(points = {{-185, -60}, {-150, -60}}, color = {0, 127, 255}, thickness = 1));
  ...
  connect(m_flow_cold.port_b, Cp_coldIn.port) annotation(
    Line(points = {{-185, -60}, {-180, -60}, {-180, -63}}, color = {0, 127, 255}));
  ...
  connect(m_flow_cold.m_flow, Capacity_hotIn.u2) annotation(
    Line(points = {{-190, -65.5}, {-190, -78.5}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(Cp_coldIn.y_Cp, Capacity_hotIn.u1) annotation(
    Line(points = {{-175, -68.5}, {-175, -70}, {-184, -70}, {-184, -79}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  ...
  connect(ramp_T_coldIn.y, souce_coolant.T_in) annotation(
    Line(points = {{-249.5, -56}, {-242, -56}}, color = {0, 0, 127}));
  ...
  connect(ramp_m_flow_cold.y, souce_coolant.m_flow_in) annotation(
    Line(points = {{-249.5, -40}, {-246, -40}, {-246, -52}, {-240, -52}}, color = {0, 0, 127}));
//--------------------
...
//--------------------
  ...
  connect(volC9.ports[2], T_coldOut.port_a) annotation(
  ...
  annotation(
    Diagram(coordinateSystem(extent = {{-260, -100}, {220, 120}})),
    experiment(StartTime = 0, StopTime = 30, Tolerance = 1e-6, Interval = 0.06));
end HX_ShellTube_parallel_discrete010_ex01;
