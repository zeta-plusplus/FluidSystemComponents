...
model HX_Cross_BothUnmixed_NTU00_ex01
  ...
  Modelica.Fluid.Sources.Boundary_pT boundary2(redeclare package Medium = liquid1, T = 288.15, nPorts = 1, p = 101.325*1000) annotation(
    Placement(transformation(origin = {76, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ...
  FluidSystemComponents.HeatTransfer.Components.HX_CrossFlow_BothUnmixed_NTU00 HX(redeclare package Medium1 = liquid1, redeclare package Medium2 = liquid2, A_par = 10) annotation(
    Placement(transformation(origin = {-24, 3.42857}, extent = {{-24, -20.4286}, {24, 20.4286}})));
...
equation
  ...
  connect(pipe.port_b, boundary2.ports[1]) annotation(
    Line(points = {{46, 20}, {66, 20}, {66, 20}, {66, 20}}, color = {0, 127, 255}));
  connect(boundary.ports[1], HX.port_1_med1) annotation(
    Line(points = {{-72, 20}, {-48, 20}}, color = {0, 127, 255}));
  connect(HX.port_2_med1, pipe.port_a) annotation(
    Line(points = {{0, 20}, {26, 20}}, color = {0, 127, 255}));
  ...
  connect(boundary1.ports[1], HX.port_1_med2) annotation(
    Line(points = {{-60, -40}, {-48, -40}, {-48, -13}}, color = {0, 127, 255}));
  connect(HX.port_2_med2, pipe1.port_a) annotation(
    Line(points = {{0, -13}, {0, -30}, {20, -30}}, color = {0, 127, 255}));
  annotation(
...
end HX_Cross_BothUnmixed_NTU00_ex01;
