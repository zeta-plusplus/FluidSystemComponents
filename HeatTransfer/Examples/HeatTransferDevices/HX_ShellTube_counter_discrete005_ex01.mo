...
model HX_ShellTube_counter_discrete005_ex01
  ...
  Modelica.Fluid.Sensors.TemperatureTwoPort T_coldOut(redeclare package Medium = liquidCside) annotation(
    Placement(visible = true, transformation(origin = {-75, -60}, extent = {{5, 5}, {-5, -5}}, rotation = 0)));
  ...
  Modelica.Fluid.Sensors.TemperatureTwoPort T_coldIn(redeclare package Medium = liquidCside) annotation(
    Placement(visible = true, transformation(origin = {140, -60}, extent = {{5, 5}, {-5, -5}}, rotation = 0)));
  ...
  Modelica.Fluid.Sensors.MassFlowRate m_flow_cold(redeclare package Medium = liquidCside) annotation(
    Placement(visible = true, transformation(origin = {125, -60}, extent = {{5, 5}, {-5, -5}}, rotation = 0)));
  ...
  FluidSystemComponents.Sensor.SpecificHeatCapacity Cp_coldIn(redeclare package Medium = liquidCside) annotation(
    Placement(visible = true, transformation(origin = {110, -68}, extent = {{-5, 5}, {5, -5}}, rotation = 270)));
  ...
  Modelica.Blocks.Math.Product Capacity_hotIn annotation(
    Placement(visible = true, transformation(origin = {122, -83}, extent = {{-5, 5}, {5, -5}}, rotation = -90)));
  ...
  Modelica.Blocks.Sources.Ramp ramp_T_coldIn(duration = 1, height = 0, offset = 10 + 273.15, startTime = 25) annotation(
    Placement(visible = true, transformation(origin = {185, -56}, extent = {{5, -5}, {-5, 5}}, rotation = 0)));
...
equation
  ...
  connect(T_coldOut.port_b, sink_coolant.ports[1]) annotation(
    Line(points = {{-80, -60}, {-90, -60}}, color = {0, 127, 255}, thickness = 1));
  ...
  connect(souce_coolant.ports[1], T_coldIn.port_a) annotation(
    Line(points = {{150, -60}, {145, -60}}, color = {0, 127, 255}, thickness = 1));
  ...
  connect(T_coldIn.port_b, m_flow_cold.port_a) annotation(
    Line(points = {{135, -60}, {130, -60}}, color = {0, 127, 255}, thickness = 1));
  ...
  connect(m_flow_cold.port_b, Cp_coldIn.port) annotation(
    Line(points = {{120, -60}, {115, -60}, {115, -68}}, color = {0, 127, 255}));
  ...
  connect(m_flow_cold.m_flow, Capacity_hotIn.u2) annotation(
    Line(points = {{125, -65.5}, {125, -77}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(Cp_coldIn.y_Cp, Capacity_hotIn.u1) annotation(
    Line(points = {{110, -73.5}, {110, -72}, {119, -72}, {119, -77}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  ...
  connect(ramp_T_coldIn.y, souce_coolant.T_in) annotation(
    Line(points = {{179.5, -56}, {172, -56}}, color = {0, 0, 127}));
  ...
  connect(ramp_m_flow_cold.y, souce_coolant.m_flow_in) annotation(
    Line(points = {{179.5, -40}, {176.75, -40}, {176.75, -52}, {170, -52}}, color = {0, 0, 127}));
//--------------------
...
//--------------------
  ...
  connect(volC4.ports[2], m_flow_cold.port_b) annotation(
    Line(points = {{70, -60}, {120, -60}}, color = {0, 127, 255}, thickness = 1));
  connect(T_coldOut.port_a, volC.ports[2]) annotation(
    Line(points = {{-70, -60}, {-50, -60}}, color = {0, 127, 255}, thickness = 1));
  annotation(
    Diagram(coordinateSystem(extent = {{-180, -100}, {200, 120}})),
    experiment(StartTime = 0, StopTime = 30, Tolerance = 1e-6, Interval = 0.06));
end HX_ShellTube_counter_discrete005_ex01;
