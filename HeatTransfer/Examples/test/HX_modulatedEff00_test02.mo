...
model HX_modulatedEff00_test02
...
equation
  ...
  connect(boundary.ports[1], HX.port_2_med1) annotation(
    Line(points = {{-60, 50}, {12, 50}, {12, 18}, {0, 18}, {0, 18}}, color = {0, 127, 255}));
  connect(ramp1.y, HX.u_eff) annotation(
    Line(points = {{-59, 10}, {-22, 10}}, color = {0, 0, 127}));
  connect(HX.port_2_med2, boundary3.ports[1]) annotation(
    Line(points = {{0, 2}, {14, 2}, {14, -30}, {60, -30}, {60, -30}}, color = {0, 127, 255}));
