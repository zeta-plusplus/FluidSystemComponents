...
equation
  ...
  connect(HX.port_2_med2, pipe1.port_a) annotation(
    Line(points = {{0, 24}, {8, 24}, {8, -10}, {20, -10}, {20, -10}}, color = {0, 127, 255}));
  ...
  connect(HX.port_2_med1, pipe.port_a) annotation(
    Line(points = {{0, 38}, {10, 38}, {10, 50}, {20, 50}, {20, 50}}, color = {0, 127, 255}));
  connect(ramp1.y, HX.u_eff) annotation(
    Line(points = {{-58, 20}, {-48, 20}, {-48, 30}, {-22, 30}, {-22, 30}}, color = {0, 0, 127}));
  connect(boundary1.ports[1], HX.port_1_med2) annotation(
    Line(points = {{-60, -10}, {-34, -10}, {-34, 24}, {-20, 24}, {-20, 23}}, color = {0, 127, 255}));
  connect(boundary.ports[1], HX.port_1_med1) annotation(
    Line(points = {{-60, 50}, {-32, 50}, {-32, 36}, {-20, 36}, {-20, 38}}, color = {0, 127, 255}));
annotation(
