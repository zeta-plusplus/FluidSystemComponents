...
model HX_modulatedEff00_test03
...
equation
  ...
  connect(HX.port_2_med1, boundary2.ports[1]) annotation(
    Line(points = {{0, 18}, {12, 18}, {12, 40}, {60, 40}, {60, 40}}, color = {0, 127, 255}));
  connect(boundary.ports[1], HX.port_1_med1) annotation(
    Line(points = {{-60, 50}, {-34, 50}, {-34, 18}, {-20, 18}, {-20, 18}}, color = {0, 127, 255}));
