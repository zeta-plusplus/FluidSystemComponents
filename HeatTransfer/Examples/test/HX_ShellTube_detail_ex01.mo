...
model HX_ShellTube_detail_ex01
  ...
  //--------------------
  parameter units.CoefficientOfHeatTransfer kConvH=500.0 "heat transfer coefficient, hot side";
  parameter units.CoefficientOfHeatTransfer kConvC=500.0 "heat transfer coefficient, cold side";
  parameter units.Area areaH=5.0;
  parameter units.Area areaC=5.0;
...
equation
  ...
  connect(kA_H.y, convection.Gc) annotation(
    Line(points = {{-89.5, 13}, {-50, 13}, {-50, 30}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(kA_H.y, convection1.Gc) annotation(
    Line(points = {{-89.5, 13}, {-20, 13}, {-20, 30}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(kA_H.y, convection2.Gc) annotation(
    Line(points = {{-89.5, 13}, {10, 13}, {10, 30}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(kA_H.y, convection3.Gc) annotation(
    Line(points = {{-89.5, 13}, {40, 13}, {40, 30}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(kA_H.y, convection4.Gc) annotation(
    Line(points = {{-89.5, 13}, {70, 13}, {70, 30}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(kA_C.y, convection5.Gc) annotation(
    Line(points = {{-89.5, -11}, {-50, -11}, {-50, -30}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(kA_C.y, convection6.Gc) annotation(
    Line(points = {{-89.5, -11}, {-20, -11}, {-20, -30}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(kA_C.y, convection7.Gc) annotation(
    Line(points = {{-89.5, -11}, {10, -11}, {10, -30}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(kA_C.y, convection8.Gc) annotation(
    Line(points = {{-89.5, -11}, {40, -11}, {40, -30}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(kA_C.y, convection9.Gc) annotation(
    Line(points = {{-89.5, -11}, {70, -11}, {70, -30}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
...
//--------------------
  Rtotal = 1.0 / (kConvH * areaH) + 1.0 / (kConvC * areaC);
  UAtotal= 1.0/Rtotal;
