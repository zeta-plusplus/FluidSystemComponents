...
//-------------------------
  ...
  annotation(
    ...
    Icon(graphics = {Text(origin = {0, -126}, extent = {{-140, 18}, {140, -2}}, textString = "%name"), Polygon(origin = {0, 6}, fillColor = {255, 170, 127}, fillPattern = FillPattern.Solid, points = {{-150, 56}, {-150, -56}, {150, -56}, {150, 56}, {130, 56}, {130, 42}, {-130, 42}, {-130, 56}, {-150, 56}}), Line(origin = {-138.91, 54.94}, points = {{-1, 15}, {-1, -11}}, thickness = 2, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 5), Line(origin = {-0.32, -29.32}, points = {{-140, -49}, {-136, 29}, {138, 29}, {140, -53}}, color = {0, 170, 255}, thickness = 12), Line(origin = {141.41, 80.28}, points = {{-1, -35}, {-1, -11}}, thickness = 2, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 5), Line(origin = {97.05, 11.26}, points = {{15, -11}, {-9, -11}}, thickness = 2, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 5), Line(origin = {-147.19, 10.09}, points = {{59, -11}, {29, -11}}, thickness = 2, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 5), Line(origin = {-96.02, 32.85}, points = {{13, -11}, {49, -11}}, thickness = 2, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 5), Line(origin = {31.75, 34.56}, points = {{13, -11}, {45, -11}}, thickness = 2, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 5)}, coordinateSystem(preserveAspectRatio = false, extent = {{-140, -100}, {140, 100}}, initialScale = 0.1)),
