...
model effHX_NTU_Cross_BothUnmixed_test01
  ...
  effHX_NTU_Cross_BothUnmixed block_effHX annotation(
...
equation
  ...
  connect(const_ratioDmCp.y, block_effHX.u_ratioDmCp) annotation(
    Line(points = {{-52, -12}, {-44, -12}, {-44, 24}, {-30, 24}}, color = {0, 0, 127}));
  annotation(
    experiment(StartTime = 0, StopTime = 10, Tolerance = 1e-06, Interval = 0.02));
end effHX_NTU_Cross_BothUnmixed_test01;
