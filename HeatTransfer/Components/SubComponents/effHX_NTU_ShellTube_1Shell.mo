...
block effHX_NTU_ShellTube_1Shell
...
equation
  ...
  y_effHX= 2*(1+u_ratioDmCp+sqrt(1+u_ratioDmCp^2)*(1+exp(-1*u_NTU*sqrt(1+u_ratioDmCp^2)))/(1-exp(-1*u_NTU*sqrt(1+u_ratioDmCp^2))) )^(-1);
...
Shell Tube
1shell")}));
end effHX_NTU_ShellTube_1Shell;
