...
//-------------------------
  ...
  Icon(graphics = {Text(origin = {0, -126}, extent = {{-140, 18}, {140, -2}}, textString = "%name"), Rectangle( fillColor = {255, 170, 127}, fillPattern = FillPattern.Solid, extent = {{-80, 60}, {80, -60}}), Line(origin = {0, 20.79}, points = {{-100, -20.7929}, {-80.0002, 19.2071}, {79.9998, 19.2071}, {100, -20.7929}}, color = {170, 0, 0}, thickness = 2), Line(origin = {0, 40.79}, points = {{-100, -40.7929}, {-80.0002, 19.2071}, {79.9998, 19.2071}, {100, -40.7929}}, color = {170, 0, 0}, thickness = 2), Line(origin = {0, 0.79}, points = {{-100, -0.7929}, {-80.0002, 19.2071}, {79.9998, 19.2071}, {100, -0.7929}}, color = {170, 0, 0}, thickness = 2), Line(origin = {0, -19.21}, points = {{-100, 19.2071}, {-80.0002, 19.2071}, {79.9998, 19.2071}, {100, 19.2071}}, color = {170, 0, 0}, thickness = 2), Line(origin = {0, -39.21}, points = {{-100, 39.2071}, {-80.0002, 19.2071}, {79.9998, 19.2071}, {100, 39.2071}}, color = {170, 0, 0}, thickness = 2), Line(origin = {0, -59.21}, points = {{-100, 59.2071}, {-80.0002, 19.2071}, {79.9998, 19.2071}, {100, 59.2071}}, color = {170, 0, 0}, thickness = 2), Line(origin = {0, -79.21}, points = {{-100, 79.2071}, {-80.0002, 19.2071}, {79.9998, 19.2071}, {100, 79.2071}}, color = {170, 0, 0}, thickness = 2), Line(origin = {-120, 40}, points = {{-20, 40}, {-20, -40}, {22, -40}}, color = {255, 170, 127}, thickness = 10), Line(origin = {-138.91, 60.94}, points = {{-1, 15}, {-1, -11}}, thickness = 2, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 5), Line(origin = {136, 48}, points = {{-36, -48}, {4, -48}, {4, 32}}, color = {255, 170, 127}, thickness = 10), Line(origin = {141.09, 30.94}, points = {{-1, 15}, {-1, 35}}, thickness = 2, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 5), Line(origin = {-39.89, 0}, points = {{39.8937, -80}, {-40.1063, -60}, {-40.1063, 60}, {39.8937, 80}}, color = {85, 0, 255}, thickness = 3), Line(origin = {-19.89, 0}, points = {{19.8937, -80}, {-40.1063, -60}, {-40.1063, 60}, {19.8937, 80}}, color = {85, 0, 255}, thickness = 3), Line(origin = {0.11, 0}, points = {{-0.1063, -80}, {-40.1063, -60}, {-40.1063, 60}, {-0.1063, 80}}, color = {85, 0, 255}, thickness = 3), Line(origin = {20.11, 0}, points = {{-20.1063, -80}, {-40.1063, -60}, {-40.1063, 60}, {-20.1063, 80}}, color = {85, 0, 255}, thickness = 3), Line(origin = {40.11, 0}, points = {{-40.1063, -80}, {-40.1063, -60}, {-40.1063, 60}, {-40.1063, 80}}, color = {85, 0, 255}, thickness = 3), Line(origin = {60.11, 0}, points = {{-60.1063, -80}, {-40.1063, -60}, {-40.1063, 60}, {-60.1063, 80}}, color = {85, 0, 255}, thickness = 3), Line(origin = {-72, -14}, points = {{-68, -66}, {72, -66}}, color = {0, 170, 255}, thickness = 10), Line(origin = {-134.91, -95.06}, points = {{-1, 15}, {21, 15}}, thickness = 2, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 5), Line(origin = {80.11, 0}, points = {{-80.1063, -80}, {-40.1063, -60}, {-40.1063, 60}, {-80.1063, 80}}, color = {85, 0, 255}, thickness = 3), Line(origin = {120.11, 0}, points = {{-120.106, -80}, {-40.1063, -60}, {-40.1063, 60}, {-120.106, 80}}, color = {85, 0, 255}, thickness = 3), Line(origin = {100.11, 0}, points = {{-100.106, -80}, {-40.1063, -60}, {-40.1063, 60}, {-100.106, 80}}, color = {85, 0, 255}, thickness = 3), Line(origin = {106, 132}, points = {{-106, -52}, {10, -52}, {10, -200}, {34, -214}}, color = {0, 170, 255}, thickness = 10), Line(origin = {12, 72}, points = {{-12, -8}, {-12, 8}, {12, 8}}, thickness = 3, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 6), Line(origin = {109.09, -89.06}, points = {{5, 23}, {21, 15}}, thickness = 2, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 5), Line(origin = {-9, -72}, points = {{-9, -8}, {9, -8}, {9, 8}}, thickness = 3, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 6)}, coordinateSystem(preserveAspectRatio = false, extent = {{-140, -100}, {140, 100}}, initialScale = 0.1)),
