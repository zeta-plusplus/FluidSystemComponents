...
annotation(
  ...
  Icon(graphics = {Ellipse(lineColor = {0, 170, 0}, fillColor = {220, 255, 216}, fillPattern = FillPattern.Solid, lineThickness = 3, extent = {{-100, 100}, {100, -100}})}, coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.2)),
