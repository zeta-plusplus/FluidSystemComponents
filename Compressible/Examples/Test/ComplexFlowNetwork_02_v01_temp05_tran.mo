...
model ComplexFlowNetwork_02_v01_temp05_tran
  ...
  //-------------------------
  inner Modelica.Fluid.System system(T_start(displayUnit = "K") = 500, m_flow_start = 0.1, massDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, momentumDynamics = Modelica.Fluid.Types.Dynamics.DynamicFreeInitial, p_start = 10 * 100 * 1000)  annotation(
  ...
  Modelica.Blocks.Sources.Ramp ramp_valve(duration = 1, height = -1.0, offset = 1, startTime = 5) annotation(
...
equation
  ...
  annotation(
    Diagram(coordinateSystem(extent = {{-220, -100}, {200, 340}})),
...
end ComplexFlowNetwork_02_v01_temp05_tran;
