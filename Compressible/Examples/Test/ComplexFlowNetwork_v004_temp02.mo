...
model ComplexFlowNetwork_v004_temp02
  ...
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction(redeclare package Medium = Modelica.Media.Air.DryAirNasa) annotation(
    Placement(visible = true, transformation(origin = {-90, -140}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction1(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.02 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {130, -190}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction2(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.01 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {150, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction3(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.05 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {-210, -100}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction4(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.02 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {-100, -10}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction5(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.03 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {-50, 44}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction6(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.03 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {-210, 60}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction7(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.01 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {100, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction8(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.02 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {220, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction9(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.04 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {190, -6}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction10(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.02 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {150, 56}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction11(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.005 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {60, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction12(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.01 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {20, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction13(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.005 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {100, -38}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction14(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.01 ^ 2)  annotation(
    Placement(visible = true, transformation(origin = {-80, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction15(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.03 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {-170, 4}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction16(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.02 ^ 2) annotation(
  ...
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation03 restriction17(redeclare package Medium = Modelica.Media.Air.DryAirNasa, AmechTot_par = Modelica.Constants.pi / 4 * 0.01 ^ 2) annotation(
    Placement(visible = true, transformation(origin = {18, -170}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(pressure10.port, restriction.port_a) annotation(
    Line(points = {{-140, -140}, {-100, -140}}, color = {0, 127, 255}));
  connect(restriction.port_b, pressure11.port) annotation(
    Line(points = {{-80, -140}, {-10, -140}}, color = {0, 127, 255}));
  connect(restriction1.port_b, pressure9.port) annotation(
    Line(points = {{140, -190}, {220, -190}}, color = {0, 127, 255}));
  connect(pressure8.port, restriction1.port_a) annotation(
    Line(points = {{-50, -170}, {-50, -190}, {120, -190}}, color = {0, 127, 255}));
  connect(pressure12.port, restriction2.port_a) annotation(
    Line(points = {{70, -170}, {150, -170}, {150, -100}}, color = {0, 127, 255}));
  connect(restriction2.port_b, pressure15.port) annotation(
    Line(points = {{150, -80}, {150, 16}}, color = {0, 127, 255}));
  connect(restriction2.port_b, pressure13.port) annotation(
    Line(points = {{150, -80}, {150, -40}, {180, -40}}, color = {0, 127, 255}));
  connect(restriction3.port_a, pressure1.port) annotation(
    Line(points = {{-210, -90}, {-210, -38}}, color = {0, 127, 255}));
  connect(restriction3.port_b, pressure3.port) annotation(
    Line(points = {{-210, -110}, {-210, -140}}, color = {0, 127, 255}));
  connect(pressure4.port, restriction4.port_a) annotation(
    Line(points = {{-100, 26}, {-100, 0}}, color = {0, 127, 255}));
  connect(restriction4.port_b, pressure5.port) annotation(
    Line(points = {{-100, -20}, {-100, -38}}, color = {0, 127, 255}));
  connect(massFlowRate1.port_b, restriction5.port_a) annotation(
    Line(points = {{-100, 122}, {-100, 86}, {-50, 86}, {-50, 54}}, color = {0, 127, 255}));
  connect(restriction5.port_b, pressure6.port) annotation(
    Line(points = {{-50, 34}, {-50, -6}}, color = {0, 127, 255}));
  connect(massFlowRate.port_b, restriction6.port_a) annotation(
    Line(points = {{-210, 122}, {-210, 70}}, color = {0, 127, 255}));
  connect(pressure.port, restriction6.port_b) annotation(
    Line(points = {{-210, 26}, {-210, 50}}, color = {0, 127, 255}));
  connect(restriction7.port_a, pressure16.port) annotation(
    Line(points = {{100, 50}, {100, 30}}, color = {0, 127, 255}));
  connect(restriction7.port_b, massFlowRate3.port_a) annotation(
    Line(points = {{100, 70}, {100, 130}}, color = {0, 127, 255}));
  connect(massFlowRate5.port_a, restriction8.port_b) annotation(
    Line(points = {{220, 130}, {220, 80}}, color = {0, 127, 255}));
  connect(restriction8.port_a, pressure9.port) annotation(
    Line(points = {{220, 60}, {220, -190}}, color = {0, 127, 255}));
  connect(pressure14.port, restriction8.port_a) annotation(
    Line(points = {{190, 34}, {220, 34}, {220, 60}}, color = {0, 127, 255}));
  connect(pressure13.port, restriction9.port_a) annotation(
    Line(points = {{180, -40}, {190, -40}, {190, -16}}, color = {0, 127, 255}));
  connect(restriction9.port_b, pressure14.port) annotation(
    Line(points = {{190, 4}, {190, 34}}, color = {0, 127, 255}));
  connect(pressure15.port, restriction10.port_a) annotation(
    Line(points = {{150, 16}, {150, 46}}, color = {0, 127, 255}));
  connect(restriction10.port_b, massFlowRate4.port_a) annotation(
    Line(points = {{150, 66}, {150, 130}}, color = {0, 127, 255}));
  connect(pressure7.port, restriction11.port_a) annotation(
    Line(points = {{-50, -70}, {60, -70}, {60, 0}}, color = {0, 127, 255}));
  connect(restriction11.port_b, massFlowRate2.port_a) annotation(
    Line(points = {{60, 20}, {60, 130}}, color = {0, 127, 255}));
  connect(pressure6.port, restriction12.port_a) annotation(
    Line(points = {{-50, -6}, {-16, -6}, {-16, 30}, {10, 30}}, color = {0, 127, 255}));
  connect(restriction12.port_b, massFlowRate2.port_a) annotation(
    Line(points = {{30, 30}, {52, 30}, {52, 130}, {60, 130}}, color = {0, 127, 255}));
  connect(pressure11.port, restriction13.port_a) annotation(
    Line(points = {{-10, -140}, {100, -140}, {100, -48}}, color = {0, 127, 255}));
  connect(pressure7.port, restriction13.port_a) annotation(
    Line(points = {{-50, -70}, {86, -70}, {86, -48}, {100, -48}}, color = {0, 127, 255}));
  connect(restriction13.port_b, pressure16.port) annotation(
    Line(points = {{100, -28}, {100, 30}}, color = {0, 127, 255}));
  connect(restriction14.port_b, pressure7.port) annotation(
    Line(points = {{-70, -70}, {-50, -70}}, color = {0, 127, 255}));
  connect(pressure5.port, restriction14.port_a) annotation(
    Line(points = {{-100, -38}, {-100, -70}, {-90, -70}}, color = {0, 127, 255}));
  connect(pressure.port, restriction15.port_a) annotation(
    Line(points = {{-210, 26}, {-170, 26}, {-170, 14}}, color = {0, 127, 255}));
  connect(pressure2.port, restriction15.port_b) annotation(
    Line(points = {{-170, -38}, {-170, -6}}, color = {0, 127, 255}));
  connect(restriction16.port_a, pressure2.port) annotation(
    Line(points = {{-180, -70}, {-170, -70}, {-170, -38}}, color = {0, 127, 255}));
  connect(restriction16.port_b, restriction3.port_a) annotation(
    Line(points = {{-200, -70}, {-210, -70}, {-210, -90}}, color = {0, 127, 255}));
  connect(restriction3.port_b, orifice2.port_a) annotation(
    Line(points = {{-210, -110}, {-210, -140}, {-180, -140}}, color = {0, 127, 255}));
  connect(orifice2.port_b, pressure10.port) annotation(
    Line(points = {{-160, -140}, {-140, -140}}, color = {0, 127, 255}));
  connect(pressure8.port, restriction17.port_a) annotation(
    Line(points = {{-50, -170}, {8, -170}}, color = {0, 127, 255}));
  connect(restriction17.port_b, pressure12.port) annotation(
    Line(points = {{28, -170}, {70, -170}}, color = {0, 127, 255}));
protected
  annotation(
...
end ComplexFlowNetwork_v004_temp02;
