...
model ComplexFlowNetwork_v002
  ...
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation01 flowPath(redeclare package Medium = Modelica.Media.Air.DryAirNasa) annotation(
