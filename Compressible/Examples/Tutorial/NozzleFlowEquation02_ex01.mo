...
model NozzleFlowEquation02_ex01
  ...
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation02 flowPath(redeclare package Medium = SecondaryAir) annotation(
    Placement(visible = true, transformation(origin = {0, 10}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation02 flowPath1(redeclare package Medium = SecondaryAir) annotation(
