...
model ComplexFlowNetwork_ex02_v01
  ...
  Modelica.Blocks.Sources.Ramp ramp_p_bc2(duration = 1, height = -1 * 100 * 1000, offset = 10 * 100 * 1000, startTime = 11) annotation(
    Placement(visible = true, transformation(origin = {91, 238}, extent = {{6, -6}, {-6, 6}}, rotation = 0)));
...
equation
  ...
  connect(restriction.port_b, volume.ports[1]) annotation(
    Line(points = {{-164, 84}, {-164, 48}}, color = {0, 127, 255}));
  connect(restriction1.port_a, volume.ports[2]) annotation(
  ...
  connect(restriction1.port_b, volume1.ports[1]) annotation(
    Line(points = {{-164, -6}, {-164, -60}}, color = {0, 127, 255}));
  connect(restriction2.port_a, volume1.ports[2]) annotation(
  ...
  connect(ramp_p_bc2.y, boundary2.p_in) annotation(
    Line(points = {{84.4, 238}, {84.4, 238.5}, {74.4, 238.5}, {74.4, 238}}, color = {0, 0, 127}));
  connect(ramp_p_bc3.y, boundary3.p_in) annotation(
    Line(points = {{130.4, 216}, {120, 216}}, color = {0, 0, 127}));
  ...
  connect(ramp_p_bc4.y, boundary4.p_in) annotation(
    Line(points = {{174.4, 195}, {168.4, 195}, {168.4, 194}}, color = {0, 0, 127}));
  ...
  connect(ramp_p_bc6.y, boundary6.p_in) annotation(
    Line(points = {{232, 202}, {226.4, 202}}, color = {0, 0, 127}));
  ...
  connect(ramp_p_bc7.y, boundary7.p_in) annotation(
    Line(points = {{235.5, 239}, {243, 239}}, color = {0, 0, 127}));
  connect(ramp_p_bc8.y, boundary8.p_in) annotation(
    Line(points = {{290.5, 224}, {283.5, 224}}, color = {0, 0, 127}));
  connect(boundary9.p_in, ramp_p_bc81.y) annotation(
    Line(points = {{319.2, 239.8}, {324.2, 239.8}}, color = {0, 0, 127}));
  ...
  connect(restriction36.port_a, volume18.ports[5]) annotation(
    Line(points = {{306, 178}, {306, 172}, {290, 172}, {290, 150}}, color = {0, 127, 255}));
  connect(restriction34.port_b, boundary7.ports[1]) annotation(
    Line(points = {{256, 199}, {256, 234}}, color = {0, 127, 255}));
  ...
  connect(restriction36.port_b, boundary9.ports[1]) annotation(
    Line(points = {{306, 190}, {306, 236}}, color = {0, 127, 255}));
  annotation(
