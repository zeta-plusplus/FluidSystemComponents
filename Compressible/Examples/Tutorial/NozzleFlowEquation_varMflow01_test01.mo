...
model NozzleFlowEquation_varMflow01_test01
  ...
  Modelica.Blocks.Sources.Ramp ramp_m_flow_abs(duration = 1, height = 0.4, offset = 2, startTime = 3) annotation(
    Placement(visible = true, transformation(origin = {-40, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FluidSystemComponents.Compressible.Components.NozzleFlowEquation_varMflow01 restriction(redeclare package Medium = gas1)  annotation(
...
equation
  ...
  connect(ramp_m_flow_abs.y, restriction.u_m_flow_abs) annotation(
    Line(points = {{-28, 46}, {-11, 46}, {-11, 27}}, color = {0, 0, 127}));
...
end NozzleFlowEquation_varMflow01_test01;
