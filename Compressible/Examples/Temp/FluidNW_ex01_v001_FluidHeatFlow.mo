...
model FluidNW_ex01_v001_FluidHeatFlow
  ...
  Modelica.Blocks.Sources.Constant open_b0_0(k = 1) annotation(
    Placement(visible = true, transformation(origin = {-156, 78}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant open_b1_1(k = 1) annotation(
    Placement(visible = true, transformation(origin = {-36, 78}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant open_b2_2(k = 1) annotation(
  ...
  Modelica.Blocks.Sources.Constant open_0_1(k = 1) annotation(
    Placement(visible = true, transformation(origin = {-76, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Sources.Constant open_1_2(k = 1) annotation(
    Placement(visible = true, transformation(origin = {44, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Thermal.FluidHeatFlow.Components.Valve rst_b0_0(Kv1 = 1, LinearCharacteristic = false, T0 = 15 + 273.15, dp0(displayUnit = "Pa") = 1, frictionLoss = 0, kv0 = 0.01, m = 0, medium = medium1, rho0 = 10, y1 = 1) annotation(
    Placement(visible = true, transformation(origin = {-116, 98}, extent = {{-30, -10}, {-10, 10}}, rotation = 90)));
  Modelica.Thermal.FluidHeatFlow.Components.Valve rst_b1_1(Kv1 = 1, LinearCharacteristic = false, T0 = 15 + 273.15, dp0(displayUnit = "Pa") = 1, frictionLoss = 0, kv0 = 0.01, m = 0, medium = medium1, rho0 = 10, y1 = 1) annotation(
    Placement(visible = true, transformation(origin = {4, 98}, extent = {{-30, -10}, {-10, 10}}, rotation = 90)));
  Modelica.Thermal.FluidHeatFlow.Components.Valve rst_b2_2(Kv1 = 1, LinearCharacteristic = false, T0 = 15 + 273.15, dp0(displayUnit = "Pa") = 1, frictionLoss = 0, kv0 = 0.01, m = 0, medium = medium1, rho0 = 10, y1 = 1) annotation(
    Placement(visible = true, transformation(origin = {114, 98}, extent = {{-30, -10}, {-10, 10}}, rotation = 90)));
  Modelica.Thermal.FluidHeatFlow.Components.Valve rst_0_1(Kv1 = 1, LinearCharacteristic = false, T0 = 15 + 273.15, dp0(displayUnit = "Pa") = 1, frictionLoss = 0, kv0 = 0.01, m = 0, medium = medium1, rho0 = 10, y1 = 1) annotation(
    Placement(visible = true, transformation(origin = {-96, 38}, extent = {{-30, -10}, {-10, 10}}, rotation = 180)));
  Modelica.Thermal.FluidHeatFlow.Components.Valve rst_1_2(Kv1 = 1, LinearCharacteristic = false, T0 = 15 + 273.15, dp0(displayUnit = "Pa") = 1, frictionLoss = 0, kv0 = 0.01, m = 0, medium = medium1, rho0 = 10, y1 = 1) annotation(
  ...
  Modelica.Blocks.Sources.Constant open_b1000_0(k = 1) annotation(
    Placement(visible = true, transformation(origin = {-170, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Thermal.FluidHeatFlow.Components.Valve rst_b1000_0(Kv1 = 1, LinearCharacteristic = false, T0 = 15 + 273.15, dp0(displayUnit = "Pa") = 1, frictionLoss = 0, kv0 = 0.01, m = 0, medium = medium1, rho0 = 10, y1 = 1) annotation(
  ...
  Modelica.Thermal.FluidHeatFlow.Components.Valve rst_2_b1001(Kv1 = 1, LinearCharacteristic = false, T0 = 15 + 273.15, dp0(displayUnit = "Pa") = 1, frictionLoss = 0, kv0 = 0.01, m = 0, medium = medium1, rho0 = 10, y1 = 1) annotation(
    Placement(visible = true, transformation(origin = {130, 38}, extent = {{-30, -10}, {-10, 10}}, rotation = 180)));
  Modelica.Blocks.Sources.Constant open_2_b1001(k = 1) annotation(
...
equation
  ...
  connect(open_b0_0.y, rst_b0_0.y) annotation(
    Line(points = {{-145, 78}, {-127, 78}}, color = {0, 0, 127}));
  connect(open_b1_1.y, rst_b1_1.y) annotation(
    Line(points = {{-25, 78}, {-7, 78}}, color = {0, 0, 127}));
  connect(boundary0.flowPort, rst_b0_0.flowPort_b) annotation(
    Line(points = {{-126, 108}, {-116, 108}, {-116, 88}}, color = {255, 0, 0}));
  connect(boundary1.flowPort, rst_b1_1.flowPort_b) annotation(
    Line(points = {{-6, 110}, {4, 110}, {4, 88}}, color = {255, 0, 0}));
  connect(boundary2.flowPort, rst_b2_2.flowPort_b) annotation(
    Line(points = {{104, 110}, {114, 110}, {114, 88}}, color = {255, 0, 0}));
  connect(open_b2_2.y, rst_b2_2.y) annotation(
    Line(points = {{85, 78}, {103, 78}}, color = {0, 0, 127}));
  connect(open_0_1.y, rst_0_1.y) annotation(
    Line(points = {{-76, 15}, {-76, 27}}, color = {0, 0, 127}));
  connect(open_1_2.y, rst_1_2.y) annotation(
    Line(points = {{44, 15}, {44, 27}}, color = {0, 0, 127}));
  connect(rst_b0_0.flowPort_a, rst_0_1.flowPort_b) annotation(
    Line(points = {{-116, 68}, {-116, 38}, {-86, 38}}, color = {255, 0, 0}));
  connect(rst_0_1.flowPort_a, rst_b1_1.flowPort_a) annotation(
    Line(points = {{-66, 38}, {4, 38}, {4, 68}}, color = {255, 0, 0}));
  connect(rst_0_1.flowPort_a, rst_1_2.flowPort_b) annotation(
    Line(points = {{-66, 38}, {34, 38}}, color = {255, 0, 0}));
  connect(rst_1_2.flowPort_a, rst_b2_2.flowPort_a) annotation(
  ...
  connect(open_b1000_0.y, rst_b1000_0.y) annotation(
    Line(points = {{-170, 15}, {-170, 27}}, color = {0, 0, 127}));
  connect(rst_b1000_0.flowPort_a, rst_0_1.flowPort_b) annotation(
    Line(points = {{-160, 38}, {-86, 38}}, color = {255, 0, 0}));
  connect(boundary1000.flowPort, rst_b1000_0.flowPort_b) annotation(
  ...
  connect(open_2_b1001.y, rst_2_b1001.y) annotation(
    Line(points = {{150, 16}, {150, 28}}, color = {0, 0, 127}));
  connect(rst_1_2.flowPort_a, rst_2_b1001.flowPort_b) annotation(
    Line(points = {{54, 38}, {140, 38}}, color = {255, 0, 0}));
  connect(rst_2_b1001.flowPort_a, boundary1001.flowPort) annotation(
