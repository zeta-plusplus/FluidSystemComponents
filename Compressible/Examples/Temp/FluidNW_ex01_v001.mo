...
model FluidNW_ex01_v001
  ...
  Modelica.Fluid.Vessels.ClosedVolume vol1(redeclare package Medium= fluid1,V = volStd, nPorts = 2, use_portsData = false) annotation(
    Placement(visible = true, transformation(origin = {-360, 360}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Fluid.Vessels.ClosedVolume vol(redeclare package Medium= fluid1,V = volStd, nPorts = 2, use_portsData = false) annotation(
