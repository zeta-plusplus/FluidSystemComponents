...
equation
  ...
  connect(boundary_0_1.ports[1], rst_b0_0.port_a) annotation(
  ...
  connect(rst_b1_1.port_a, boundary_0_2.ports[1]) annotation(
    Line(points = {{10, 94}, {10, 124}}, color = {0, 127, 255}));
  connect(rst_0_1.port_a, vol_1_1.ports[1]) annotation(
  ...
  connect(rst_b2_2.port_a, boundary_0_3.ports[1]) annotation(
  ...
  connect(rst_1_2.port_a, vol_1_2.ports[4]) annotation(
  ...
  connect(rst_b1000_0.port_a, boundary_1_0.ports[1]) annotation(
  ...
  connect(rst_2_b1001.port_a, vol_1_3.ports[4]) annotation(
