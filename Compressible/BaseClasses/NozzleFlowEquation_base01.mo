...
model NozzleFlowEquation_base01
  ...
  /* 
  units.MassFlowRate m_flow_small(start = m_flow1_init) "" annotation(
    Dialog(tab = "Variables", group = "start attribute", enable = false, showStartAttribute = true));
  units.MassFlowRate m_flow_reg(start = m_flow1_init) "" annotation(
    Dialog(tab = "Variables", group = "start attribute", enable = false, showStartAttribute = true));
  */
  units.MassFlowRate m_flow_func(start = m_flow1_init) "" annotation(
    Dialog(tab = "Variables", group = "start attribute", enable = false, showStartAttribute = true));
...
//---
  ...
  */
  ...
  gamtH = Medium.specificHeatCapacityCp(fluid_H.state) / Medium.specificHeatCapacityCv(fluid_H.state);
  gamtL = Medium.specificHeatCapacityCp(fluid_L.state) / Medium.specificHeatCapacityCv(fluid_L.state);
