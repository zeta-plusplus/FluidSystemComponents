...
model CombiTimeTableAll00_ex01
  ...
  CombiTimeTableAll00 combiTimeTable1(tableOnFile = true, smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, tableName = "table01", columns = {1, 2, 3}, filePath = "modelica://FluidSystemComponents/Utilities/Examples/exampleTimeTable01.csv") annotation(
