...
model CombiTimeTable1ByName00_ex01
  ...
  CombiTimeTable1VarByName00 combiTimeTable1(strVar = "volume.medium.p", filePath = "modelica://FluidSystemComponents/Utilities/Examples/exampleTimeTable02.csv")  annotation(
