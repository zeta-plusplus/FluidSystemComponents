...
model CombiTimeTableByName00
  ...
  // parameter
  //------------------------------------------
  parameter String varNames[1,:]=["var1","var2"];
...
//************************************************************
protected
  parameter Integer nout=Modelica.Utilities.Streams.readMatrixSize(fileName, tableName);
...
annotation(
  Icon(
    coordinateSystem(preserveAspectRatio=true,
      ...
      graphics={
    Rectangle(fillColor = {255, 255, 255},fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}),
