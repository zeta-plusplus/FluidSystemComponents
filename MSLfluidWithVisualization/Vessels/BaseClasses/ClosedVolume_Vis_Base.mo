...
annotation(
    Diagram(graphics),
    Icon(graphics = {Rectangle(origin = {0, -9}, fillColor = DynamicSelect({245, 245, 245}, {vecRGB[1], vecRGB[2], vecRGB[3]}), pattern = LinePattern.Dot, fillPattern = FillPattern.Solid, extent = {{-140, 150}, {140, -130}}), Text(origin = {0, -154}, extent = {{-120, 10}, {120, -10}}, textString = DynamicSelect("0.0", String(pVis, sigDigits, 0, true)))}, coordinateSystem(extent = {{-100, -100}, {100, 100}})));
