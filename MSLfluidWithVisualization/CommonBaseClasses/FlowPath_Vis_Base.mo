...
model FlowPath_Vis_Base
  ...
  parameter Real colorMap[:, 3] = Colors.ColorMaps.jet() annotation(
    ...
    Dialog(tab = "Visualization", group = "Pressure"));
  //-----
  parameter Integer significantDigits_m_flow(min = 1) = 4 "Number of significant digits to be shown" annotation(
    Dialog(tab = "Visualization", group = "mass flow"));
  parameter units.MassFlowRate m_flow_Min = 0.01 annotation(
    Dialog(tab = "Visualization", group = "mass flow"));
  parameter units.MassFlowRate m_flow_Max = 10 annotation(
    Dialog(tab = "Visualization", group = "mass flow"));
  parameter Real thickArrowMin = 0.001 annotation(
    Dialog(tab = "Visualization", group = "mass flow"));
  parameter Real thickArrowMax = 40 annotation(
    Dialog(tab = "Visualization", group = "mass flow"));
  //----------------------------------------
  // constants
  //----------------------------------------
