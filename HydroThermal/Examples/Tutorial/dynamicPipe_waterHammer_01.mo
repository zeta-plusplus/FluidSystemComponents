...
model dynamicPipe_waterHammer_01
  ...
  Modelica.Fluid.Pipes.DynamicPipe pipe(redeclare package Medium = fluid1, diameter = 0.1, length = 10, nNodes = 10, modelStructure = Modelica.Fluid.Types.ModelStructure.av_vb, roughness(displayUnit = "m") = 1e-4) annotation(
...
equation
  ...
  annotation(
    ...
    version = "");
end dynamicPipe_waterHammer_01;