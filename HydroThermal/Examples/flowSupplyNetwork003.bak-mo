...
model flowSupplyNetwork003
  ...
  FluidSystemComponents.HydroThermal.Components.CheckValveSpringLoad_Linear checkValveSpringLoad_Linear1(redeclare package Medium = liquid1, deltapCrack = 45 * 101.3 * 1000) annotation(
...
equation
  connect(volume.ports[3], checkValveSpringLoad_Linear1.port_1) annotation(
    Line(points = {{-10, 40}, {20, 40}, {20, 10}}, color = {0, 127, 255}));
  connect(checkValveSpringLoad_Linear1.port_2, boundary.ports[2]) annotation(
    Line(points = {{20, -10}, {20, -40}, {-10, -40}}, color = {0, 127, 255}));
