...
model LiquidPowerGenerator00_02
...
equation
  connect(orifice2.port_b, HeatInjector.port_1) annotation(
    Line(points = {{50, 10}, {60, 10}, {60, 10}, {60, 10}}, color = {0, 127, 255}));
  connect(Pump.port_2, orifice2.port_a) annotation(
    Line(points = {{20, -30}, {20, -30}, {20, 10}, {30, 10}, {30, 10}}, color = {0, 127, 255}));
  connect(orifice1.port_b, Motor.port_1) annotation(
    Line(points = {{130, 10}, {140, 10}, {140, -10}, {140, -10}}, color = {0, 127, 255}));
  connect(temperature.port, orifice1.port_a) annotation(
    Line(points = {{90, 10}, {110, 10}, {110, 10}, {110, 10}}, color = {0, 127, 255}));
  connect(powerSensor1.power, Constraint.u_variable) annotation(
    Line(points = {{182, -40}, {182, -40}, {182, -70}, {198, -70}, {198, -70}}, color = {0, 0, 127}));
  connect(ramp_pwr.y, Constraint.u_targetValue) annotation(
    Line(points = {{229, -70}, {229, -70.5}, {222, -70.5}, {222, -70}}, color = {0, 0, 127}));
  connect(specificEnthalpy.port, orifice.port_a) annotation(
    Line(points = {{140, -70}, {140, -70}, {140, -80}, {140, -80}}, color = {0, 127, 255}));
  connect(Motor.port_2, specificEnthalpy.port) annotation(
