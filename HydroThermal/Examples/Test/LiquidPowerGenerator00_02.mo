...
model LiquidPowerGenerator00_02
  ...
  Modelica.Blocks.Sources.Ramp ramp_pwr(duration = 10, height = 2000, offset = 1000, startTime = 50) annotation(
  ...
  Modelica.Blocks.Sources.Ramp ramp_heat(duration = 10, height = 30, offset = 90 + 273.15, startTime = 30) annotation(
...
equation
  connect(temperature.port, PumpMotor.port_1) annotation(
    Line(points = {{90, 10}, {140, 10}, {140, -10}, {140, -10}}, color = {0, 127, 255}));
  connect(PumpMotor1.port_2, HeatInjector.port_1) annotation(
  ...
  connect(PumpMotor.port_2, specificEnthalpy.port) annotation(
