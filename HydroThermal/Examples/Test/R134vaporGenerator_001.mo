...
model R134vaporGenerator_001
  ...
  Modelica.Fluid.Examples.DrumBoiler.BaseClasses.EquilibriumDrumBoiler evaporator(redeclare package Medium = Modelica.Media.R134a.R134a_ph, V_l(fixed = true), V_l_start = 0.5, V_t = 1, cp_D = 500, energyDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, m_D = 1e-6, massDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, p(fixed = false, start = 101.325 * 1000), p_start = 3 * 101.325 * 1000) annotation(
  ...
  Modelica.Fluid.Sensors.MassFlowRate massFlowSteam(redeclare package Medium = Modelica.Media.R134a.R134a_ph) annotation(
  ...
  Modelica.Fluid.Valves.ValveLinear SteamValve(redeclare package Medium = Modelica.Media.R134a.R134a_ph, dp_nominal = 100 * 1000, m_flow_nominal = 1) annotation(
    Placement(transformation(extent = {{50, -10}, {70, -30}})));
  inner Modelica.Fluid.System system(T_ambient = (-30) + 273.15)  annotation(
  ...
  Modelica.Fluid.Sources.MassFlowSource_T pump(redeclare package Medium = Modelica.Media.R134a.R134a_ph, T = (-28) + 273.15, m_flow = 1, nPorts = 2, use_m_flow_in = true) annotation(
    Placement(visible = true, transformation(origin = {-110, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Fluid.Sources.Boundary_pT exitBoundary(redeclare package Medium = Modelica.Media.R134a.R134a_ph, T = (-24) + 273.15, nPorts = 1, p = 1 * 101.325 * 1000) annotation(
