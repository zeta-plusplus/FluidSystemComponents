...
model Pt_FluidWithMach_DispColor00
  ...
  /* ---------------------------------------------
                        Interface
                    --------------------------------------------- */
  FluidSystemComponents.Interfaces.FluidWithMach_a portStatWithMn(redeclare package Medium = Medium) annotation(
...
// isentropic between static and total
  s_fluidStat = s_fluid;
// mass conservation
  portStatWithMn.portStat.m_flow = 0;
