...
model MassFlowDispByRef00_ex01
  ...
  MassFlowDispByRef00 m_flow_orifice1(redeclare package Medium = fluid1, m_flow_dat = orifice1.m_flow) annotation(
    Placement(transformation(origin = {26, 52}, extent = {{-10, -7}, {10, 7}})));
  MassFlowDispByRef00 m_flow_par_test(redeclare package Medium = fluid1, m_flow_dat = val_m_flow_test) annotation(
