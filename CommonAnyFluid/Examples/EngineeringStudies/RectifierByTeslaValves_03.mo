...
model RectifierByTeslaValves_03
  ...
  Modelica.Fluid.Pipes.DynamicPipe pipe(redeclare package Medium = fluid1, length = 1, diameter = 0.1)  annotation(
    Placement(transformation(origin = {194, 20}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
equation
