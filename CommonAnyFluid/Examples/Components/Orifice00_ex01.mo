...
model Orifice00_ex01
  ...
  FluidSystemComponents.CommonAnyFluid.Components.Orifice00 Orifice(redeclare package Medium = fluid1, switch_input_dp = FluidSystemComponents.Types.Switches.switch_input_dp.use_Cd) annotation(
