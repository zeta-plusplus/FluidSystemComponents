...
model VariableZetaOrifice00_ex01
  ...
  FluidSystemComponents.CommonAnyFluid.Components.VariableZetaOrifice00 Orifice(redeclare package Medium = engineAir) annotation(
  ...
  Modelica.Fluid.Sources.MassFlowSource_T boundary1(redeclare package Medium = engineAir, m_flow = 0.01, nPorts = 1)  annotation(
