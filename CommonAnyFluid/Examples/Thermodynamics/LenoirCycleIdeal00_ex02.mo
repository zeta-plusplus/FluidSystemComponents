...
model LenoirCycleIdeal00_ex02
  ...
  //-----
  FluidSystemComponents.CommonAnyFluid.Thermodynamics.LenoirCycleIdeal00 LenoirCycle(redeclare package Medium = cycleFluid, switch_u_fluidQuantity = FluidSystemComponents.Types.Switches.switch_input_fluidQuantity.use_mass) annotation(
  ...
  Modelica.Blocks.Sources.Ramp ramp_massFluid(duration = 10, height = 0, offset = 1.0, startTime = 10) annotation(
...
equation
  connect(ramp_massFluid.y, LenoirCycle.par_massFluid) annotation(
    Line(points = {{-18, 70}, {24, 70}, {24, 24}, {24, 24}}, color = {0, 0, 127}));
