...
model OttoCycleIdeal00_ex01
  ...
  Modelica.Blocks.Sources.Ramp ramp_CR(duration = 10, height = 0, offset = 8, startTime = 10) annotation(
...
annotation(
    experiment(StartTime = 0, StopTime = 70, Tolerance = 1e-6, Interval = 0.14),
    __OpenModelica_simulationFlags(lv = "LOG_STATS", outputFormat = "mat", s = "dassl"));end OttoCycleIdeal00_ex01;
