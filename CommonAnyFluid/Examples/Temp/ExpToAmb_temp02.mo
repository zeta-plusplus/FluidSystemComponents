within FluidSystemComponents.CommonAnyFluid.Examples.Temp;

model ExpToAmb_temp02
  ...
  Modelica.Fluid.Sources.Boundary_pT boundary1(redeclare package Medium = engineAir, T = 15 + 273.15, nPorts = 1, p = 101.325 * 1000)  annotation(
    Placement(visible = true, transformation(origin = {76, 60}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
...
equation
  ...
  connect(boundary1.ports[1], ExpToAmb.port_2) annotation(
    Line(points = {{76, 50}, {76, 30}}, color = {0, 127, 255}));
