...
model HydrogenCoolProp_test01
  ...
  Modelica.Fluid.Vessels.ClosedVolume volume(redeclare package Medium = FluidSystemComponents.Media.CoolProp.Hydrogen, V = 0.1, nPorts = 2, use_portsData = false) annotation(
